...
| <p align="left">**Pages**<br/>- 로그인 / 회원가입 페이지<br/>- 계정복구 페이지 <br />- 관리자 (신고처리) 페이지<br/>- 닉네임 설정 페이지<br/>- 공공대출추천 페이지<br/>- 임대·행복 주택 공고 페이지<br/>**Features**<br/>- Google OAuth login<br/>- 멤버 CD<br/>- 신고 글, 댓글, 답글 RD<br/>- 임대주택 R<br/></p> | <p align="left">**Pages**<br/>- 게시글 상세 페이지<br/>- 게시글 작성 페이지<br/>- 게시글 수정 페이지<br/></br>**Features**<br/>- 게시글 CRUD<br/>- 댓글 CRUD<br/>- 답글 CRUD<br/>- 좋아요, 싫어요 RCD<br/>- 북마크 CRD<br/>- 태그 CRD</p> | <p align="left">**Pages**<br/>- 커뮤니티 페이지<br/>- 마이 페이지<br/>- 서울 전월세 페이지<br/><br/>**Features**<br/>- 게시글 검색<br/>- 페이지네이션<br/>- 게시글, 댓글, 답글 R<br/>- 멤버 RU<br/>- 서울전월세 R<br/><br/> </p> | <p align="left">**Features**<br/>- Google OAuth2.0 login<br/>- 인증 처리<br/>- 권한 처리<br/>- 회원 CRUD<br/>- 신고글, 댓글, 답글 CRUD<br/>- 마이 페이지<br/>- 북마크 기능 기능<br/>- 마이 페이지<br/></p> | <p align="left">**Features**<br/>- 배포환경 구성<br/>- 외부 api 연동 및 데이터 처리<br/>- 이미지 추가, 삭제<br/>- 인기게시글 선정 및 추천<br/>- 명예의전당 게시글 선정<br/>- 추천 게시글 선정<br/>- 게시글 검색<br/>- 좋아요, 싫어요<br/>- 게시글 CRUD<br/>- 댓글, 답글 CRUD<br/>- 태그 CRUD<br/></p> |
